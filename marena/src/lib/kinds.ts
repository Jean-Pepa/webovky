...
export const KINDS: Record<EventKind, { label: string; emoji: string; dot: string; chip: string; cell: string }> = {
  schuzka: { label: "Schůzka", emoji: "💬", dot: "bg-ink-soft", chip: "bg-black/5 text-ink-soft", cell: "bg-black/[0.04]" },
  deadline: { label: "Deadline", emoji: "⏰", dot: "bg-marigold-600", chip: "bg-marigold-100 text-marigold-800", cell: "bg-marigold-50" },
