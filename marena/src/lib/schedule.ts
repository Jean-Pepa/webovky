...
export const SCHEDULE: Day[] = [
  ...
  },
  {
    ...
    slots: [
      ...
      { from: "19:00", to: "20:00", title: P("Kapela Šelest", "Band Šelest", "Band Šelest"), kind: "kapela" },
  ...
  },
  {
    ...
    slots: [
      { from: "", title: P("Volno", "Day off", "Frei"), kind: "volno", sub: P("so 19. 9.", "Sat 19 Sep", "Sa 19. 9.") },
      {
        ...
        note: P("sraz u obelisku v Denisových sadech", "meet at the obelisk in Denis Gardens", "Treffpunkt am Obelisken in den Denis-Gärten"),
        kind: "vikend",
